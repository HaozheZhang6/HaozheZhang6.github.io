...
背景是我们一个叫 [HummingbirdRec](https://github.com/miachen0401/HummingbirdRec) 的小项目，把 HSTU 搬到 **KuaiRec**（快手放出的短视频推荐公开数据集，有视频时长、完播率这些字段）上、和 SASRec（一个经典的 self-attention 推荐基线）对比。在这个 setting 里我们试了一件事：把输入端那个纯"可学习绝对位置 embedding"，换成带 **rotary 时间戳编码**的版本。
