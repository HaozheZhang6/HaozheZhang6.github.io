...
Tesla 是这条路上公开信息最完整的一家。下面是按时间顺序看 AI Day 这几年披露的 stack 演化，最后聊聊为什么 humanoid robot 那边 locomotion 不是真正的瓶颈。
...
Tesla is the company with the cleanest public timeline on this trajectory. What follows is a chronological read of the AI Day disclosures from HydraNet onward, ending with why locomotion isn't the bottleneck for humanoid robots.
