---
layout: page
title: Multiscale Physics Modeling Integrated Materials and Structures
description: PhD thesis overview — soft-hard material integration for functional structures
img: assets/img/interests/Janus.png
importance: 1
category: physics
period: 2019 — 2023
---
...
In addition, we also investigated the mechanism of stretchable metasurfaces. Combining theoretical with **complex analysis** and computational studies, we, for the first time, shown how the rotation of nano-rods effect the optical properties.
...
{% include figure.html path="assets/img/interests/robot.png" title="robot" class="img-fluid rounded z-depth-1" zoomable=true %}
<div class="caption">
